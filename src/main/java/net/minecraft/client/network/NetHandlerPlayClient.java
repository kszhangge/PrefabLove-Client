...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handlePlayerPosLook(SPacketPlayerPosLook packetIn)
    {
        ...
        // NoRotate Start
        if (Objects.requireNonNull(PrefabLove.moduleManager.getModuleByName("NoRotate")).isEnabled() && mc.player != null && mc.player.ticksExisted > 60) {
    ...
    {
        if (PrefabLove.moduleManager.getModuleByClass(SilentDisconnect.class).isEnabled()) {
