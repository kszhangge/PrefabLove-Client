...
//                if (movingObjectPosition != null) d1 = movingObjectPosition.hitVec.distanceTo(vec3d);
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
            if (PrefabLove.moduleManager.getModuleByClass(NoHurtCam.class).isEnabled()) return;
...
//                    float f16 = this.mc.gameSettings.gammaSetting;
                    float f16 = PrefabLove.moduleManager.getModuleByClass(Xray.class).isEnabled() ? 10000 : this.mc.gameSettings.gammaSetting;
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            final var s = AuthenticationStatus.INSTANCE.magic > 50000 ? AuthenticationStatus.INSTANCE.user.getName() : "nobody";
            NanoVGHelper instance = NanoVGHelper.INSTANCE;
            instance.setupAndDraw(true, vg -> {
                var fontSize = 10;
                instance.drawTextWithFormatting(vg, s, scaledresolution.getScaledWidth() - instance.getTextWidth(vg, s, fontSize, Fonts.WQY), scaledresolution.getScaledHeight() - instance.getTextHeight(vg, fontSize, Fonts.WQY) / 2, -1, fontSize, Fonts.WQY);
            });
        }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        PrefabLove.eventBus.post(event);
