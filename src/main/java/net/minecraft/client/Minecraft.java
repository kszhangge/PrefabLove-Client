...
//        }
    ...
    public void runTick() throws IOException
    {
        ...
        if ((this.currentScreen == null || Stealer.isSilentStealing()) || this.currentScreen.allowUserInput)
        {
            ...
            PrefabLove.eventBus.post(tickEvent);
        ...
        PrefabLove.eventBus.post(clientTickEvent);
        if (this.world != null) {
            if (this.player != null) {
...
//            }
    ...
    private void processKeyBinds() {
        ...
        PrefabLove.eventBus.post(placeEvent);
    ...
    private void runTickMouse() throws IOException {
        while (Mouse.next()) {
            ...
            PrefabLove.eventBus.post(new MouseEvent(Mouse.getEventButton(), Mouse.getEventButtonState() ? 1 : 0));
    ...
    public void loadWorld(@Nullable WorldClient worldClientIn, String loadingMessage) {
        ...
        final Stealer stealer = (Stealer) PrefabLove.moduleManager.getModuleByClass(Stealer.class);
