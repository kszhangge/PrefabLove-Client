...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        if (this.mc.playerController.isSpectator()) {
            ...
            PrefabLove.eventBus.post(instance);
...
//        RenderManager.endNvgFrame();
        ...
        PrefabLove.eventBus.post(render2DEvent);
    ...
    protected void renderPotionEffects(ScaledResolution resolution)
    {
        ...
        if (!collection.isEmpty())
        {
            ...
            while (true)
            {
                ...
                if (flag && potioneffect.doesShowParticles() && !PrefabLove.moduleManager.getModuleByClass(PotionEffects.class).isEnabled())
                {
