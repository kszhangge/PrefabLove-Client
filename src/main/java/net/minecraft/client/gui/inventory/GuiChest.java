...
public class GuiChest extends GuiContainer
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        if (Stealer.isSilentStealing()) {
            ...
            // draw rect
            RenderUtil.drawRect(pos.x - width / 2, startY - PrefabLove.fontManager.font.getHeight(fontSize) - 5F, pos.x + width / 2 , startY + height, backgroundColor.getRGB());
            String str = chest.getLowerChestInventory().getDisplayName().toString();
            PrefabLove.fontManager.font.drawString(fontSize, str, (width / 2F) - (PrefabLove.fontManager.font.getStringWidth(fontSize, str) * 0.5F), -(PrefabLove.fontManager.font.getHeight(fontSize)), Color.WHITE);

//            RenderUtil.drawRect(pos.x - width / 2, startY - PrefabLove.fontManager.font.getHeight(fontSize) - 5F, pos.x + width / 2, startY - height, backgroundColor.getRGB());
//            String str = chest.getLowerChestInventory().getDisplayName().getUnformattedText();
//            PrefabLove.fontManager.font.drawString(fontSize, str, pos.x - (width / 2F) + (PrefabLove.fontManager.font.getStringWidth(fontSize, str) * 0.5F), startY - (PrefabLove.fontManager.font.getHeight(fontSize)) - 2.5F, Color.WHITE);
