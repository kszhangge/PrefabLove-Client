...
public class PlayerControllerMP
{
    ...
    public void updateController()
    {
        ...
        else
        {
            ...
            if (!this.connection.getNetworkManager().disconnected || !PrefabLove.moduleManager.getModuleByClass(SilentDisconnect.class).isEnabled()) this.connection.getNetworkManager().handleDisconnection();
        }
    }
