...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        PrefabLove.eventBus.post(preEvent);
...
//                this.connection.sendPacket(new CPacketPlayer.PositionRotation(this.posX, axisalignedbb.minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround));
            ...
            } else if (PrefabLove.moduleManager.getModuleByClass(AutoGapple.class).isEnabled()) {
                this.connection.sendPacket(new CPacketPlayer(this.onGround));
            }
...
//        if (!Disabler.getGrimPost()) {
        ...
        PrefabLove.eventBus.post(postEvent);
//        }
    }
    ...
    public void notifyDataManagerChange(DataParameter<?> key) {
        ...
        if (HAND_STATES.equals(key) && !PrefabLove.moduleManager.getModuleByClass(NoSlow.class).isEnabled()) {
    ...
    public void onLivingUpdate() {
        ...
        if ((this.isHandActive() || (KillAura.getBlocking() && !KillAura.getAutoBlockMode().equals("Fake"))) && !this.isRiding()) {
            ...
            PrefabLove.eventBus.post(slowDownEvent);
...
//        ChatUtil.info("Movement Input: " + this.movementInput.moveForward + " " + this.movementInput.moveStrafe);
        ...
        if (this.isSprinting() && !Sprint.getOmni() && (!directionCheck || this.collidedHorizontally || !flag4) || !SuperKnockBack.canSprint() && PrefabLove.moduleManager.getModuleByClass(SuperKnockBack.class).isEnabled() || !NoWeb.canSprint) {
