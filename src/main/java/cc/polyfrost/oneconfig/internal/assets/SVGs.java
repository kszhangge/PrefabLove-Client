...
public class SVGs {
    ...
    public static final SVG PREFABLOVE = new SVG("/assets/minecraft/southside/icon_white.svg");
    public static final SVG CONFIGS = new SVG("/assets/oneconfig/icons/configsicon.svg");
