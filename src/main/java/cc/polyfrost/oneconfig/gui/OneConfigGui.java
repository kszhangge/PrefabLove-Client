...
public class OneConfigGui extends OneUIScreen {
    ...
    public void draw(long vg, float partialTicks, InputHandler inputHandler) {
        ...
        nanoVGHelper.drawSvg(vg, SVGs.PREFABLOVE, x + 27f, y + 18f,  40f, 40f);
        nanoVGHelper.drawText(vg, "PREFABLOVE " + PrefabLove.CLIENT_VERSION, x + 67f, y + 40f, Colors.WHITE, 15, Fonts.BOLD);
