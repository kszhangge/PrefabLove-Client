...
import cc.polyfrost.oneconfig.gui.pages.ConfigsPage;
...
//        add(new BasicButton(width, SIZE_36, "Themes", SVGs.BRUSH, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
        ...
        add(new BasicButton(width, SIZE_36, "Configs", SVGs.CONFIGS, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
    }};
    ...
    public SideBar() {
        ...
        buttons.get(9).setClickAction(new ConfigsPage());
