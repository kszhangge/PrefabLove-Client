...
public class ModuleManager {
    ...
    public void initialize() {
        ...
        // World
        this.register(new AutoPhase("AutoPhase","自动穿笼子",Category.World,true));

        // Client
        this.register(new Debug("Debug", "测试模块", Category.Client, true));
        this.register(new Notification("Notification", "显示消息", Category.Client, false));
        ...
        this.register(new AutoGapple("AutoGapple","自动吃金苹果",Category.Combat,true));
        this.register(new Surround("Surround", "把你的dick围起来", Category.Combat, true));
        this.register(new AA("AA", "ez", Category.Combat, true));
        this.register(new BackTrack("BackTrack", "回溯", Category.Combat, true));
        ...
        this.register(new FastLadder("FastLadder", "快速梯子", Category.Movement, true));
        ...
        this.register(new FreeCam("FreeCam", "免费相机", Category.Render, true));
        ...
        this.register(new AutoReport("AutoReport", "自动举报", Category.Misc, true));
    ...
    private void register(BaseModule base) {
        if (base instanceof Module module) {
            ...
            PrefabLove.eventBus.subscribe(nonToggleableModule);
