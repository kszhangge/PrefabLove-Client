...
//            this.drawIcon(vg, x, yOffset, scale);
            ...
            nanoVGHelper.drawText(vg, duration, x + 590 * scale - PrefabLove.fontManager.font.getStringWidth(35 * scale, duration), y + 125 * scale, Color.WHITE.getRGB(), 35 * scale, Fonts.REGULAR);
        }
    }
}
