...
public class ModdedMainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        nanovg.setupAndDraw(true, vg -> {
            ...
            nanovg.drawText(vg, PrefabLove.CLIENT_NAME, (scaledResolution.getScaledWidth() / 2f) - (nanovg.getTextWidth(vg, PrefabLove.CLIENT_NAME, 50, Fonts.BOLD) / 2f),
                    80.0F, new Color(255, 255, 255, (int) (255 * finalValue)).getRGB(), 50,
                    Fonts.BOLD
            );
        });
