...
public class NameTag extends Module {
    ...
    private void drawNameTag(EntityLivingBase entity, boolean bloom, float partialTicks) {
        ...
        HackerDetector hackerDetector = (HackerDetector) PrefabLove.moduleManager.getModuleByClass(HackerDetector.class);
...
//            PrefabLove.fontManager.wqy_microhei.drawString(fontSize, finalName, left + 8F, top + fontHeight * 0.5F, Color.WHITE);
//            PrefabLove.fontManager.wqy_microhei.drawString(8, "Health: " + String.format("%.1f", entity.getHealth()), left + 8F, top + fontHeight * 1.7F, Color.WHITE);
