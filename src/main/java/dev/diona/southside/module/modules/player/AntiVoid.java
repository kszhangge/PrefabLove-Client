...
public class AntiVoid extends Module {
    ...
    public void onRender(Render2DEvent event) {
        ...
        PrefabLove.fontManager.font.drawString(12, "assessment: " + new ProjectileUtil.EnderPearlPredictor(mc.player.posX, mc.player.posY, mc.player.posZ, mc.player.motionY - 0.01, mc.player.motionY + 0.02).assessRotation(RotationUtil.getPlayerRotation()), 20, 20, Color.WHITE);
        PrefabLove.fontManager.font.drawString(12, "(" + mc.player.rotationYaw + ", " + mc.player.rotationPitch + ")", 20, 30, Color.WHITE);
    }
    ...
    public void onMotion(MotionEvent event) {
        ...
        if (mc.player.onGround) {
            if (scaffoldEnabled) {
                PrefabLove.moduleManager.getModuleByClass(Scaffold.class).setEnable(false);
        ...
        if (mc.player.motionY < 0.1 && new FallingPlayer(mc.player).findCollision(60) == null && !PlayerUtil.isBlockUnder(mc.player.posY + mc.player.getEyeHeight()) && mc.player.fallDistance > fallDistValue.getValue().floatValue()) {
            Scaffold scaffold = (Scaffold) PrefabLove.moduleManager.getModuleByClass(Scaffold.class);
            Stuck stuck = (Stuck) PrefabLove.moduleManager.getModuleByClass(Stuck.class);
...
//                PrefabLove.moduleManager.getModuleByName("Stuck").setEnable(true);
    ...
    public boolean onDisable() {
        PrefabLove.moduleManager.getModuleByName("Stuck").setEnable(false);
