        ...
        synchronized (messages) {
            ...
            if (event.getState() == EventState.PRE) {
                ...
                for (int i = 0; i < messages.size(); i++) {
                    ...
                    float width = Math.max(minWidth, PrefabLove.fontManager.font.getStringWidth(fontSize, message.message) + extraWidth);
            ...
            ClientStyle clientStyle = PrefabLove.styleManager.getStyle();
            for (NotificationMessage message : messages) {
                float width = Math.max(minWidth, PrefabLove.fontManager.font.getStringWidth(fontSize, message.message) + extraWidth);
                ...
                PrefabLove.fontManager.font.drawString(9F, message.title, message.x.get() + 6, message.y.get() + 4, fontColor);
                PrefabLove.fontManager.font.drawString(fontSize, message.message, message.x.get() + 6, message.y.get() + height - PrefabLove.fontManager.font.getHeight(fontSize) * 1.7F, fontColor);
            }
        }
    }
