...
//        subComponents.add(new SwordComponent(this));
...
//        subComponents.add(new SharpAxeComponent(this));
        subComponents.add(new TNTComponent(this));
//        subComponents.add(new KnockBackComponent(this));
...
//        ChatUtil.info("DROP");
    ...
    public void onMotion(MotionEvent event) {
        ...
        if (PrefabLove.moduleManager.getModuleByClass(AutoGapple.class).isEnabled()) return;
        ...
        final NewStealer newStealer = (NewStealer) PrefabLove.moduleManager.getModuleByClass(NewStealer.class);
