...
//                    ConfigCore.saveAll();
    ...
    public void printUsage() {
        ChatUtil.sendText("Usage:\n"
                + PrefabLove.commandManager.PREFIX + "config load <name>\n"
                + PrefabLove.commandManager.PREFIX + "config rename <name> <newname>\n"
                + PrefabLove.commandManager.PREFIX + "config remove <name>\n"
                + PrefabLove.commandManager.PREFIX + "config create <name>\n"
                + PrefabLove.commandManager.PREFIX + "config copy <name>\n"
                + PrefabLove.commandManager.PREFIX + "config list"
        );
    }
}
